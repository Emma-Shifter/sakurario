...
namespace sakurario.States
{
    public class Level4 : Level
    {
            ...
            : base(game, graphicsDevice, content, 4)
        {
            ...
            _smallSnakes.Add(new Sprite(SMAnimations) { isSnake = true, Position = new Vector2(150, 235), Size = new Point(90, 177), });
            _bigSnakes.Add(new Sprite(SBAnimations) { isSnake = true, Position = new Vector2(590, 210), Size = new Point(90, 177), });
        }
    }
}
